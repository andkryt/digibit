...
import com.google.digibyte.core.Sha256Hash;
...
public class MultiBitFrame extends JFrame implements ViewSystem, ApplicationListener, WalletBusyListener, CurrencyConverterListener {
    ...
    private void setupTray() {
        ...
        Image trayIconIcon = new ImageIcon(this.getClass().getResource("/images/digibit64.png")).getImage();
        trayIcon = new TrayIcon(trayIconIcon, "DigiBit");
