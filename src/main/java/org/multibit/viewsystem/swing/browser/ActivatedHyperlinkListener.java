...
public class ActivatedHyperlinkListener implements HyperlinkListener {
    ...
    private static final String MULTIBIT_HOST_NAME = "www.digibit.cryptoservices.net";
    private static final String MULTIBIT_HOST_NAME2 = "digibit.cryptoservices.net";
