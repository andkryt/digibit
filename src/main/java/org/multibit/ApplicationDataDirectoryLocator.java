...
public class ApplicationDataDirectoryLocator {
     ...
     * 
     * 1. See if there is a digibit.properties in DigiBit's current working
     ...
     * 
     * PC System.getenv("APPDATA")/DigiBitInExecutableJar
     * 
     * e.g. C:/Documents and Settings/Administrator/Application Data/DigiBitInExecutableJar
     * 
     * Mac System.getProperty("user.home")/Library/Application Support/DigiBitInExecutableJar
     * 
     * e.g. /Users/jim/Library/Application Support/DigiBitInExecutableJar
     * 
     * Linux System.getProperty("user.home")/DigiBitInExecutableJar
     * 
     * e.g. /Users/jim/DigiBitInExecutableJar
     */
    public String getApplicationDataDirectory() {
        ...
        if (multibitPropertiesFile.exists()) {
            ...
            if (operatingSystemName != null && operatingSystemName.startsWith("Windows")) {
                // Windows os
                applicationDataDirectory = System.getenv("APPDATA") + File.separator + "DigiBit";
            } else {
                if (operatingSystemName != null && operatingSystemName.startsWith("Mac")) {
                    ...
                    if ( (new File("../../../../" + FileHandler.USER_PROPERTIES_FILE_NAME)).exists()) {
                        ...
                        applicationDataDirectory = System.getProperty("user.home") + "/Library/Application Support/DigiBit";
                    }
                } else {
                    // treat as Linux/ unix variant
                    applicationDataDirectory = System.getProperty("user.home") + "/DigiBit";
                }
            }
     ...
     * This is the directory into which DigiBit was installed.
     * @throws IOException 
     * 
