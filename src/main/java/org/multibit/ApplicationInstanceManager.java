...
public final class ApplicationInstanceManager {
    ...
    /**
     * DigiBit port number. Must be different to Multibit as specified in
     * http://en.wikipedia.org/wiki/List_of_TCP_and_UDP_port_numbers
     */
    public static final int MULTIBIT_NETWORK_SOCKET = 14044;

    /**
     * Multibit message start - must end with newline
     */
    public static final String MESSAGE_START = "$$DigiBitMessageStart$$\n";
