...
import com.google.digibyte.uri.BitcoinURI;
...
public class QRCodeGenerator {
    ...
    public BufferedImage generateQRcode(String address, String amount, String label, int scaleFactor) {
        ...
        try {
            ...
            //log.warn("The address '" + address + "' could not be converted to a digibyte address. (IAE)");
            return null;
        } catch (AddressFormatException e) {
            //log.warn("The address '" + address + "' could not be converted to a digibyte address. (AFE)");
            return null;
        }
