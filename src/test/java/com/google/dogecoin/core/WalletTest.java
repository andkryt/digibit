...
package com.google.digibyte.core;

import com.google.digibyte.core.CoreTestUtils.BlockPair;
import com.google.digibyte.core.WalletTransaction.Pool;
import com.google.digibyte.crypto.KeyCrypter;
import com.google.digibyte.crypto.KeyCrypterException;
import com.google.digibyte.crypto.KeyCrypterScrypt;
import com.google.digibyte.store.BlockStore;
import com.google.digibyte.store.MemoryBlockStore;
import com.google.digibyte.utils.BriefLogFormatter;
import com.google.digibyte.utils.Threading;
...
import static com.google.digibyte.core.Utils.toNanoCoins;
...
public class WalletTest {
    ...
    private Transaction sendMoneyToWallet(Wallet wallet, Transaction tx, AbstractBlockChain.NewBlockType type) throws IOException,
        ...
        if (type == null) {
            ...
            BlockPair bp = com.google.digibyte.core.CoreTestUtils.createFakeBlock(params, blockStore, tx);
    ...
    private Transaction sendMoneyToWallet(Wallet wallet, BigInteger value, Address toAddress, AbstractBlockChain.NewBlockType type)
        ...
        return sendMoneyToWallet(wallet, com.google.digibyte.core.CoreTestUtils.createFakeTx(params, value, toAddress), type);
    }

    private Transaction sendMoneyToWallet(BigInteger value, AbstractBlockChain.NewBlockType type) throws IOException,
            VerificationException {
        return sendMoneyToWallet(this.wallet, com.google.digibyte.core.CoreTestUtils.createFakeTx(params, value, myAddress), type);
    }
  ...
  @Test
   public void largeBalance() throws Exception {
    ...
    public void pending1() throws Exception {
        ...
        com.google.digibyte.core.CoreTestUtils.BlockPair fakeBlock = CoreTestUtils.createFakeBlock(params, blockStore, t1Copy);
