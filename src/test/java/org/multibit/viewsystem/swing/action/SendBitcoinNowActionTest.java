...
public class SendBitcoinNowActionTest extends TestCase {
    ...
    private static final String EXPECTED_SEND_FAILED = "The send of your digibyte failed.";
    private static final String EXPECTED_THE_WALLET_IS_BUSY = "The wallet is busy with the task \"\"";
    private static final String EXPECTED_YOUR_BITCOIN_WERE_SENT_SUCCESSFULLY = "Your digibyte were sent successfully.";
    private static final String EXPECTED_SENDING_BITCOIN = "Sending digibyte...";
    ...
    private File createMultiBitRuntime() throws IOException {
        ...
        File multibitCheckpoints = new File(multiBitDirectoryPath + File.separator + "digibit.checkpoints");
        FileHandler.copyFile(new File("./src/main/resources/digibit.checkpoints"), multibitCheckpoints);
