...
import com.google.digibyte.crypto.EncryptedPrivateKey;
...
public class ExportPrivateKeysSubmitActionTest extends TestCase {   
    ...
    public void testNoWalletSelected() throws Exception {
        ...
        assertEquals("Wrong message after receive digibyte confirm with no active wallet", ResetTransactionsSubmitActionTest.EXPECTED_NO_WALLET_IS_SELECTED, ((Message)messages[messages.length - 1]).getText());
    }
}
